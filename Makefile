#############################################################################
# Makefile for building: AutodartsAudio
# Generated by qmake (3.1) (Qt 6.4.2)
# Project:  AutodartsAudio.pro
# Template: app
# Command: /usr/bin/qmake6 -o Makefile AutodartsAudio.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = AutodartsAudio1.0.0
DISTDIR = /home/darts/Dokumente/AudioStreamer/.tmp/AutodartsAudio1.0.0
LINK          = g++
...
DIST          = /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		...
		AutodartsAudio.pro  main.cpp
QMAKE_TARGET  = AutodartsAudio
DESTDIR       = 
TARGET        = AutodartsAudio


first: all
####### Build rules

AutodartsAudio:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET)  $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: AutodartsAudio.pro /usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++/qmake.conf /usr/lib/x86_64-linux-gnu/qt6/mkspecs/features/spec_pre.prf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/unix.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/linux.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/sanitize.conf \
		/usr/lib/x86_64-linux-gnu/qt6/mkspecs/common/gcc-base.conf \
	...
	$(QMAKE) -o Makefile AutodartsAudio.pro
...
main.moc: main.cpp \
	...
	/usr/lib/qt6/libexec/moc $(DEFINES) --include /home/darts/Dokumente/AudioStreamer/moc_predefs.h -I/usr/lib/x86_64-linux-gnu/qt6/mkspecs/linux-g++ -I/home/darts/Dokumente/AudioStreamer -I/usr/include/x86_64-linux-gnu/qt6 -I/usr/include/x86_64-linux-gnu/qt6/QtWidgets -I/usr/include/x86_64-linux-gnu/qt6/QtGui -I/usr/include/x86_64-linux-gnu/qt6/QtCore -I/usr/include/c++/13 -I/usr/include/x86_64-linux-gnu/c++/13 -I/usr/include/c++/13/backward -I/usr/lib/gcc/x86_64-linux-gnu/13/include -I/usr/local/include -I/usr/include/x86_64-linux-gnu -I/usr/include main.cpp -o main.moc
